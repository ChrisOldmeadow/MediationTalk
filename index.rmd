...
.blue[CDE: ]The difference in counterfactual outcomes when $A=1$ compared to $A=0$, when $M$ is fixed at $m$]
...
# Natural Direct Effect (NDE)
 ...
 .blue[NDE:] The effect of comparing treatment level $A=1$ to $A=0$, when intervening to fix $M=M_0$
...
.blue[NIE:] The effect of comparing $M=M_1$ vs $M=M_0$ when  intervening to fix $A=1$]
...
$NIE = \theta_2*\beta_1 + \theta_3*\beta_1a(a-a^{\star})$
...
1. Fit model for M|A,C and Y|M,A,C
